...
import me.gavin.mvvm.databinding.WidgetBannerViewBinding;
import me.gavin.mvvm.R;
import me.gavin.mvvm.util.DisplayUtil;
...
public class BannerView extends FrameLayout {
    ...
    private WidgetBannerViewBinding binding;
    ...
    private void initView(Context context) {
        binding = WidgetBannerViewBinding.inflate(LayoutInflater.from(context));
