...
import me.gavin.mvvm.util.CacheHelper;
import me.gavin.mvvm.util.okhttp.OKHttpCacheInterceptor;
import me.gavin.mvvm.util.okhttp.OKHttpCacheNetworkInterceptor;
import me.gavin.mvvm.util.okhttp.OKHttpLoggingInterceptor;
...
//                .serializeNulls()//把null值也转换，默认是不转换null值的，可以选择也转换,为空时输出为{a:null}，而不是{}
    ...
    public OkHttpClient provideClient(HttpLoggingInterceptor logging, OKHttpLoggingInterceptor logging2,
        ...
        return new OkHttpClient.Builder()
                ...
                .readTimeout(30, TimeUnit.SECONDS) // 发送数据超时
                .writeTimeout(10, TimeUnit.SECONDS) // 返回数据超时
